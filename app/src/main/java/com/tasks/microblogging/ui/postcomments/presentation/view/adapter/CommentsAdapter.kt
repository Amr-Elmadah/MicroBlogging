package com.tasks.microblogging.ui.postcomments.presentation.view.adapter
...
import com.tasks.microblogging.databinding.ItemCommentBinding
...
class CommentsAdapter : BaseRecyclerAdapter<Comment>() {
    ...
    private class CommentsViewHolder(val binding: ItemCommentBinding) : RecyclerView.ViewHolder(binding.root) {
